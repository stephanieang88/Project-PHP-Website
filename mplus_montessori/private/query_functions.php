...
function insert_product($product) {
   ...
   $sql .= "(category, grade, position, visible, item_no, product_name, price, description, image_path, submission_date) ";
   $sql .= "VALUES (";
...
function update_product_without_image($product) {
   global $db;

   $sql = "UPDATE catalogue SET ";
   $sql .= "category='" . $product['category'] . "', ";
   $sql .= "grade='" . $product['grade'] . "', ";
   $sql .= "position='" . $product['position'] . "', ";
   $sql .= "visible='" . $product['visible'] . "', ";
   $sql .= "item_no='" . $product['item_no'] . "', ";
   $sql .= "product_name='" . $product['product_name'] . "', ";
   $sql .= "price='" . $product['price'] . "', ";
   $sql .= "description='" . $product['description'] . "', ";
   $sql .= "submission_date='" . date("Y-m-d") . "' ";
...
function update_product_with_image($product) {
   global $db;
   ...
   $sql .= "price='" . $product['price'] . "', ";
   $sql .= "description='" . $product['description'] . "', ";
   $sql .= "image_path='" . $product['image_path'] . "', ";
   $sql .= "submission_date='" . date("Y-m-d") . "' ";
   $sql .= "WHERE id='" . $product['id'] . "' ";
   $sql .= "LIMIT 1";
