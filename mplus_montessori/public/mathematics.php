...
<?php
	 ...
	 $sql = "SELECT * FROM catalogue WHERE category='Mathematics'";
...
<?php include(SHARED_PATH . '/header.php'); ?>
	...
	<section>
		<div class="jumbotron jumbotron-fluid subpage mt-0 mb-3 py-0">
			<img class="img-fluid" src="images/Elementary9-12_3840x1200px_1.jpg" alt="...">
			<div>
				<h2>Mathematics</h2>
				<p class="d-none d-md-block">Of all the Montessori apparatus,<br>
					the Math Materials are the most glamorous. They are beautiful,<br>
					showy, and in their simplicity, supremely intelligent.<br>
					They give children a sensorial experience of the<br>
					abstraction that is mathematics.
				</p>
			</div>
	</section>
