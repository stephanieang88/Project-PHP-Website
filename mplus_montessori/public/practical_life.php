...
<?php
    ...
    $sql = "SELECT * FROM catalogue WHERE category='Practical Life'";
...
<?php include(SHARED_PATH . '/header.php'); ?>
    ...
    <section>
        <div class="jumbotron jumbotron-fluid subpage mt-0 mb-3 py-0">
            <img class="img-fluid" src="images/EarlyChildhood3-6_3840x1200px_1.jpg" alt="...">
            <div>
                <h2>Practical Life</h2>
                <p class="d-none d-md-block">When children come into the world,<br>
                    into the world, their first function is to adapt to<br>
                    to their environment so that they may become <br>
                    a member of the human group which<br>
